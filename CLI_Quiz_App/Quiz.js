...
const quiz = await inquirer.prompt([
    ...
    },
    {
        name: "question_2",
        type: "list",
        message: "Q2. Which character is commonly allowed in variable names in TypeScript?",
        choices: ["$", "@", "#", "&"],
    },
    {
        name: "question_3",
    ...
    },
    {
        name: "question_4",
        type: "list",
        message: "Q4. Which symbol is commonly used to terminate a statement in TypeScript?",
        choices: [";", ",", ".", ".;"],
    },
    {
        name: "question_5",
